...
import { ChatState, ContactState, DashboardItems, DashboardItemTypes, ServiceState } from '../../types/reducers'
...
export const updateItemsOnDashboard = createAction(
  UPDATE_ITEMS_ON_DASHBOARD, ({ entity, entityType }: { entity: any; entityType: DashboardItemTypes } ) => ({ entity, entityType })
)
